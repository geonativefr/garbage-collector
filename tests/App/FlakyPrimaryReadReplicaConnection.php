...
/**
 * A primary-replica connection whose next query fails the way a MySQL server dropping an idle
 * connection does.
 *
 ...
 */
final class FlakyPrimaryReadReplicaConnection extends PrimaryReadReplicaConnection
{
    /**
     * @var string[]
     */
